                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
                            <p>
                                I am a highly motivated and enthusiastic junior-intern developer
                                with a strong desire to learn and grow
                                in the field of software development.
                            </p>

                            <p>
                                I specialize in Python, Django, React, PostgreSQL,
                                building everything from sleek landing pages to complex
                                enterprise applications. My approach combines technical excellence
                        ...
                        <div className="glass rounded-2xl p-6 glow-border animate-fade-in animation-delay-300">
                            <p className="text-lg font-medium italic text-foreground">
                                "My mission is to create digital experience that are not just functional but truly
